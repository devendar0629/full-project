import { CLOUDINARY_THUMBNAIL_FOLDER, CLOUDINARY_VIDEO_FOLDER } from "../constants.js";
...
const uploadNewVideo = asyncHandler(async (req,res) => {
    ...
    */
    ...
    const thumbnail = await uploadFile(thumbnailLocalPath,CLOUDINARY_THUMBNAIL_FOLDER)
